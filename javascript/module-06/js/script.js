...
class Hamburger {
  ...
  removeTopping(topping) {
    ...
    this._toppings.includes(topping) 
      ? this._toppings.splice(this.toppings.indexOf(topping), 1) : this.toppings;
    */
  }
  ...
  calculatePrice() {
    ...
    const totalPrice = hamburgerSizePrice + hamburgerStuffingPrice 
  ...
  calculateCalories() {
    ...
    const hamburgerToppingCalories = this.toppings.reduce((acc, value) => {
      return acc + Hamburger.TOPPINGS[value].calories;
    }, 0);

    const totalCalories = hamburgerSizeCalories + hamburgerStuffingCalories 
